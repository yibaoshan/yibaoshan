...
从各级标题可以看出来，文章绝大多数的篇幅都在介绍触摸事件。实际上，Android 系统不单只有触摸事件，还有来自鼠标，键盘，音量键、电源键等其他设备的事件需要处理。

但他们的传递路径都是相同的，因此，文中没有单独也并不打算单独介绍他们

好，在文章的开头，我们先来聊聊触摸事件的起源
...
图中的小点点就是屏幕的触控芯片，米10的触控芯片使用的是，来自意法半导体"FJABH"触控芯片方案，这块芯片是用来干嘛的呢？
