...
OLED显示原理虽然比另外两位要先进不少，但是在刷新方式上和LCD基本上相同，参考上一章的LCD液晶屏刷新原理就可以了
...
屏幕刷新率为什么能够超频的原因我暂时还不清楚，想要超频自己手机的小伙伴一定要先去[论坛](https://www.akr-developers.com/?q=%E8%B6%85%E9%A2%91)找一下有没有成功的先例

随意超频可能会出现点击偏移、显示卡顿、LCD可能会出现残影等待现象，非常不建议折腾自己的主力机

### 什么是帧率？

说完了刷新率我们接着说帧率（Frame Rate）
...
电影放映机的胶片以每秒456毫米8.0英寸的速度（也就是24 fps）穿过投影机，最终投射到幕布上，这就是帧率，简单来说就是源文件的速率

有的同学可能要问了：不对，计算机的画面都是由CPU或GPU实时渲染的，跟播放视频是两回事啊
...
> 1. 如何在我的60HZ的显示器上播放24帧的电影？同理，90/120/144HZ是如何播放的？
> 2. 我的手机摄像很牛逼，支持120帧录制视频，但是手机的屏幕很拉胯，才60HZ，用手机录下来的120FPS视频使用60HZ的屏幕来回放时，看到的是120帧还是60帧？
> 3. 同理，显卡每秒能生成250帧画面，但是显示器只有60HZ，多出来的190帧画面是不是丢弃了？如果是丢弃了岂不是很浪费？
...
最后，我在写本篇文章查询了非常多的资料，以下都是我个人觉得还不错的内容，希望对大家能有所帮助

- **关于视频的帧率，推荐影视飓风团队在B站的视频：[【硬核科普】奇妙的帧率增加了！](https://www.bilibili.com/video/BV1kE411c7yZ)**

- **关于显示器的刷新率，推荐The Slow Mo Guys团队在YouTube上的视频：[《How a TV Works in Slow Motion？》](https://www.youtube.com/watch?v=3BJU2drrtCM)**

  > 没法科学上网的小伙伴可以去B栈看搬运视频：[【科普】显示屏是如何工作的？](https://www.bilibili.com/video/BV11W411H7Bo)

- **关于垂直同步，推荐硬件茶谈在B站的视频：[【硬件科普】全网最详细易懂的G-sync Freesync 垂直同步工作原理科普](https://www.bilibili.com/video/BV1FK4y1x7bk)**

  > 视频制作的还是挺不错的，但有几处比较明显的错误，比如LCD液晶屏上的逐行刷新起码是一次更新一行像素，而不是和CRT的逐行刷新类似
  >
  > 所以大家看完视频后一定要记得去评论区查看ID叫做[xman12346](https://space.bilibili.com/272833187)大佬的发言，一定要看
