...
随意超频可能会出现点击偏移、显示卡顿、LCD可能会出现残影等待现象，非常不建议自己折腾自己的主力机
...
前面介绍了什么是刷新率和帧率，这两点单独理解起来都不难，但是将它俩组合在一起时，情况就变了复杂了一些，比如：
