# Android图形架构概述(上)：屏幕硬件和屏幕驱动

本篇是Android View系列的第一篇文章，主要讨论的是Android手机屏幕的种类和解释屏幕相关的技术名词
...
- OLED屏幕支持更高的亮度、对比度以及更鲜艳的色彩
- 更快的响应速度，高刷体验更好
- 不需要背光板，采用COP方案封装，理论上可以去掉宽下巴

基于以上优点，目前绝大多数手机厂商的旗舰机使用的都是OLED屏幕，在全面屏时代，LCD被彻底的抛下车
...
PWM全称是xxxxx，广泛应用于xxxxx

低频PWM调光会给眼睛带来额外的负担，而且如何频率太低，还可能引发癫痫
