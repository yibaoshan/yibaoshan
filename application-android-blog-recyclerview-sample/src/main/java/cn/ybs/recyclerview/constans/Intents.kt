...
object Intents {
    ...
    const val INTENT_VALUE_VERTICAL_GRID_LAYOUT_TEXT = "intent_value_vertical_grid_layout_text"

    const val INTENT_VALUE_VERTICAL_STAGGERED_LAYOUT_TEXT = "intent_value_vertical_staggered_layout_text"

    const val INTENT_VALUE_VERTICAL_FLEXBOX_LAYOUT_TEXT = "intent_value_vertical_flexbox_layout_text"
