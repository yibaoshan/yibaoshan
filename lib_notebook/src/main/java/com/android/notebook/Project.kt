...
class Project {
    ...
    /**
     * 移动应用隐私合规检测系统，基于相关法律法规及行业规范，GB35273-2020 个人信息安全规范标准，从个人信息收集、权限使用场景、隐私政策描述等多个维度对应进行隐私安全合规检测，并能够自动化输出合规检测报告，JANUS大数据平台及移动应用隐私协议大数据平台的支撑，保证了检测结果的准确性，使客户能够更好的发现相关问题，规避隐私合规风险。
    ...
    -----------------------------------
    ©著作权归作者所有：来自51CTO博客作者zancun的原创作品，如需转载，请注明出处，否则将追究法律责任
    APP安全在线检测
    https://blog.51cto.com/zhaoshilei/2702646
     * */
