package com.android.blackboard.util;
...
/**
 * Created by yibaoshan@foxmail.com on 2019/4/25
 * Description : 屏幕适配方案
 * * <br>
...
public class ScreenMatch {
    ...
    public static void register(@NonNull final Application application, final float designSize, final int matchBase, final int matchUnit) {
        ScreenMatch.designSize = designSize;
        if (mActivityLifecycleCallback == null) {
            mActivityLifecycleCallback = new Application.ActivityLifecycleCallbacks() {
                ...
                public void onActivityCreated(Activity activity, Bundle savedInstanceState) {
                    ...
                    if (activity.getClass().getSimpleName().contains("SplashActivity")) return;
    ...
    public static class ScreenWidth {
        ...
        public static float dp2px(int dp) {
            return dp * (getMatchInfo().getScreenWidth() * 1f / designSize);
        }

        public static float dp2px(int dp, float designSize) {
            return dp * (getMatchInfo().getScreenWidth() * 1f / designSize);
        }
    ...
    public static class ScreenHeight {
        ...
        public static float dp2px(int dp) {
            return dp * (getMatchInfo().getScreenHeight() * 1f / designSize);
        }
