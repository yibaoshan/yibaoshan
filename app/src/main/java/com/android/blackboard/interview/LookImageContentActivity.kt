...
import com.android.blackboard.custom.PinchImageView

class LookImageContentActivity : AppCompatActivity() {

    companion object {

        @JvmStatic
        fun startContentActivity(activity: Activity, title: String, resId: Int) {
            val intent = Intent(activity, LookImageContentActivity::class.java)
